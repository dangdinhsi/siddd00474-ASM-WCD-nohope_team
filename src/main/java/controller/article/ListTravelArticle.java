...
public class ListTravelArticle extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        query = query.filter("categoryid", 3).filter("status",1);
        ...
        req.getRequestDispatcher("/article/travel.jsp").forward(req,resp);
