...
public class ListSportArticle extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        query = query.filter("categoryid", 2).filter("status",1);
        ...
        req.getRequestDispatcher("/article/sport.jsp").forward(req,resp);
