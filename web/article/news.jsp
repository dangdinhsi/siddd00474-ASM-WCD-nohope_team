                ...
                <div class="col-md-4 text-center">
                    <ul>
                        <%
                            if (currentPage > 1){
                        %>
                        <a href="/home/news?page=1&limit=<%=currentLimit%>"><<</a>
                        <%
                            }
                        %>
                        <%
                            if (currentPage > 1){
                        %>
                        <a href="/home/news?page=<%=currentPage-1%>&limit=<%=currentLimit%>"><</a>
                        <%
                            }
                        %>
                        ...
                        <%
                            if (currentPage - 2 > 1){
                        %>
                        <a href="/home/news?page=<%=currentPage-2%>&limit=<%=currentLimit%>"><%=currentPage - 2%></a>
                        <%
                            }
                        %>
                        <%
                            if (currentPage - 1 > 1){
                        %>
                        <a href="/home/news?page=<%=currentPage-1%>&limit=<%=currentLimit%>"><%=currentPage - 1%></a>&nbsp;
                        <%
                            }
                        %>
                        ...
                        <%
                            if (currentPage < totalPage){
                        %>
                        <a href="/home/news?page=<%=totalPage%>&limit=<%=currentLimit%>">>></a>
                        <%
                            }
                        %>
                    </ul>
